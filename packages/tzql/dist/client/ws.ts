...
export interface DzqlAPI {
  ...
  subscribe_venue_detail: (params: VenueDetailParams, callback: (data: unknown) => void) => Promise<{ data: unknown; subscription_id: string; schema: unknown; unsubscribe: () => Promise<void> }>;
  ...
  subscribe_org_dashboard: (params: OrgDashboardParams, callback: (data: unknown) => void) => Promise<{ data: unknown; subscription_id: string; schema: unknown; unsubscribe: () => Promise<void> }>;
  ...
  subscribe_my_profile: (params: MyProfileParams, callback: (data: unknown) => void) => Promise<{ data: unknown; subscription_id: string; schema: unknown; unsubscribe: () => Promise<void> }>;
}
...
export class GeneratedWebSocketManager extends WebSocketManager {
  ...
  constructor(options: { maxReconnectAttempts?: number; tokenName?: string } = {}) {
    super(options);
    this.api = {
      login_user: (params: any) => this.call('login_user', params),
      register_user: (params: any) => this.call('register_user', params),
      get_users: (params: any) => this.call('get_users', params),
      save_users: (params: any) => this.call('save_users', params),
      delete_users: (params: any) => this.call('delete_users', params),
      search_users: (params: any) => this.call('search_users', params),
      lookup_users: (params: any) => this.call('lookup_users', params),
      get_organisations: (params: any) => this.call('get_organisations', params),
      save_organisations: (params: any) => this.call('save_organisations', params),
      delete_organisations: (params: any) => this.call('delete_organisations', params),
      search_organisations: (params: any) => this.call('search_organisations', params),
      lookup_organisations: (params: any) => this.call('lookup_organisations', params),
      get_acts_for: (params: any) => this.call('get_acts_for', params),
      save_acts_for: (params: any) => this.call('save_acts_for', params),
      delete_acts_for: (params: any) => this.call('delete_acts_for', params),
      search_acts_for: (params: any) => this.call('search_acts_for', params),
      lookup_acts_for: (params: any) => this.call('lookup_acts_for', params),
      get_venues: (params: any) => this.call('get_venues', params),
      save_venues: (params: any) => this.call('save_venues', params),
      delete_venues: (params: any) => this.call('delete_venues', params),
      search_venues: (params: any) => this.call('search_venues', params),
      lookup_venues: (params: any) => this.call('lookup_venues', params),
      get_sites: (params: any) => this.call('get_sites', params),
      save_sites: (params: any) => this.call('save_sites', params),
      delete_sites: (params: any) => this.call('delete_sites', params),
      search_sites: (params: any) => this.call('search_sites', params),
      lookup_sites: (params: any) => this.call('lookup_sites', params),
      get_products: (params: any) => this.call('get_products', params),
      save_products: (params: any) => this.call('save_products', params),
      delete_products: (params: any) => this.call('delete_products', params),
      search_products: (params: any) => this.call('search_products', params),
      lookup_products: (params: any) => this.call('lookup_products', params),
      get_packages: (params: any) => this.call('get_packages', params),
      save_packages: (params: any) => this.call('save_packages', params),
      delete_packages: (params: any) => this.call('delete_packages', params),
      search_packages: (params: any) => this.call('search_packages', params),
      lookup_packages: (params: any) => this.call('lookup_packages', params),
      get_allocations: (params: any) => this.call('get_allocations', params),
      save_allocations: (params: any) => this.call('save_allocations', params),
      delete_allocations: (params: any) => this.call('delete_allocations', params),
      search_allocations: (params: any) => this.call('search_allocations', params),
      lookup_allocations: (params: any) => this.call('lookup_allocations', params),
      get_contractor_rights: (params: any) => this.call('get_contractor_rights', params),
      save_contractor_rights: (params: any) => this.call('save_contractor_rights', params),
      delete_contractor_rights: (params: any) => this.call('delete_contractor_rights', params),
      search_contractor_rights: (params: any) => this.call('search_contractor_rights', params),
      lookup_contractor_rights: (params: any) => this.call('lookup_contractor_rights', params),
      get_brands: (params: any) => this.call('get_brands', params),
      save_brands: (params: any) => this.call('save_brands', params),
      delete_brands: (params: any) => this.call('delete_brands', params),
      search_brands: (params: any) => this.call('search_brands', params),
      lookup_brands: (params: any) => this.call('lookup_brands', params),
      get_artwork: (params: any) => this.call('get_artwork', params),
      save_artwork: (params: any) => this.call('save_artwork', params),
      delete_artwork: (params: any) => this.call('delete_artwork', params),
      search_artwork: (params: any) => this.call('search_artwork', params),
      lookup_artwork: (params: any) => this.call('lookup_artwork', params),
      get_tags: (params: any) => this.call('get_tags', params),
      save_tags: (params: any) => this.call('save_tags', params),
      delete_tags: (params: any) => this.call('delete_tags', params),
      search_tags: (params: any) => this.call('search_tags', params),
      lookup_tags: (params: any) => this.call('lookup_tags', params),
      get_venue_detail: (params: any) => this.call('get_venue_detail', params),
      venue_detail_can_subscribe: (params: any) => this.call('venue_detail_can_subscribe', params),
      get_org_dashboard: (params: any) => this.call('get_org_dashboard', params),
      org_dashboard_can_subscribe: (params: any) => this.call('org_dashboard_can_subscribe', params),
      get_my_profile: (params: any) => this.call('get_my_profile', params),
      my_profile_can_subscribe: (params: any) => this.call('my_profile_can_subscribe', params),
      subscribe_venue_detail: (params: any, callback: (data: any) => void) => this.subscribe('subscribe_venue_detail', params, callback),
      subscribe_org_dashboard: (params: any, callback: (data: any) => void) => this.subscribe('subscribe_org_dashboard', params, callback),
      subscribe_my_profile: (params: any, callback: (data: any) => void) => this.subscribe('subscribe_my_profile', params, callback),
    } as DzqlAPI;
  }
}
